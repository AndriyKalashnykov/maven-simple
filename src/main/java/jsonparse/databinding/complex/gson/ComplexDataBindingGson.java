...
import jsonparse.databinding.complex.gson.generated.NeoDetails;
import jsonparse.databinding.complex.gson.generated.NeoWsDataGson;
import jsonparse.databinding.simple.GsonLocalDateAdapter;

public class ComplexDataBindingGson {

  public static void main(String[] args) {

    NeoWsDataGson neoWsDataGson =
        new GsonBuilder()
    ...
    System.out.println(
        "Potentially hazardous asteroids: "
            + neoWsDataGson.nearEarthObjects.values().stream()
                .flatMap(
                    Collection
