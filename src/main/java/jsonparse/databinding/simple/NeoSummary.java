...
class NeoSummary {
  ...
  private static void jacksonDataBinding() throws IOException {
    ...
    NeoSummaryDetails neoSummaryDetails =
        objectMapper.readValue(neoSummaryJsonString, NeoSummaryDetails.class);
  ...
  private static void gsonDataBinding() {
    Gson gson =
        new GsonBuilder().registerTypeAdapter(LocalDate.class, new GsonLocalDateAdapter()).create();

    NeoSummaryDetails neoSummaryDetails =
        gson.fromJson(neoSummaryJsonString, NeoSummaryDetails.class);
