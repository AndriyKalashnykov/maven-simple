...
public class GsonTreeModel {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Potentially hazardous asteroids: " + getPotentiallyHazardousAsteroidCount(neoJsonElement));
  ...
  private static int getNeoCount(JsonElement neoJsonElement) {
    return neoJsonElement.getAsJsonObject().get("element_count").getAsInt();
  }
  ...
  private static int getPotentiallyHazardousAsteroidCount(JsonElement neoJsonElement) {
    ...
    for (Map.Entry<String, JsonElement> neoClosestApproachDate :
        nearEarthObjects.getAsJsonObject().entrySet()) {
