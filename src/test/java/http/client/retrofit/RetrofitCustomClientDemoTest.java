...
/**
 * Offline smoke test: runs {@link RetrofitCustomClientDemo#main} end-to-end against an in-process
 * WireMock stub (base URL injected via the {@code articleUsersBaseUrl} system property) so {@code
 * make test} exercises the demo wiring without a live network call. Contract assertions live in
 * {@link RetrofitClientIT}.
 */
@WireMockTest
class RetrofitCustomClientDemoTest {
